...
import { EventsController, GearbagsController, MarketplaceTrustController, MessagesController, NotificationsController, OrganizationsController, ReportsController, TeamsController } from './community.controller';
...
@Module({imports:[TypeOrmModule.forFeature([...communityEntities,Listing])],providers:[CommunityService],controllers:[GearbagsController,TeamsController,OrganizationsController,EventsController,MessagesController,MarketplaceTrustController,NotificationsController,ReportsController],exports:[TypeOrmModule,CommunityService]})
